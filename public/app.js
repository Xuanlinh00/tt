...
class UIManager {
    ...
    styleScoreSheetWorksheet(worksheet, reportRowsCount, includeClassColumn) {
        ...
        worksheet['!merges'] = [
            ...
            { s: { r: 15 + N, c: 0 }, e: { r: 15 + N, c: 3 } },
            { s: { r: 15 + N, c: 4 }, e: { r: 15 + N, c: 7 } },
            { s: { r: 15 + N, c: 8 }, e: { r: 15 + N, c: lastCol } },
            { s: { r: 16 + N, c: 8 }, e: { r: 16 + N, c: lastCol } },
            { s: { r: 22 + N, c: 0 }, e: { r: 22 + N, c: 3 } },
            { s: { r: 22 + N, c: 4 }, e: { r: 22 + N, c: 7 } },
            { s: { r: 22 + N, c: 8 }, e: { r: 22 + N, c: lastCol } }
        ];
